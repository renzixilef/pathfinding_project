...
%********************************
Die Funktionalität des Interfaces beschränkt sich auf die Klasse \texttt{RunnerParent} und ihre Subklassen \texttt{SingleRun} und \texttt{MultiRun}.
...
Zur Kommunikation mit der \ac{GUI} wird das threadsichere \texttt{SIGNAL-SLOT}-Prinzip des \textit{Qt5}-Frameworks eingesetzt.
\begin{itemize}
